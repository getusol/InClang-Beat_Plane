...
void ui_menu_init_stage2(void)
{
    ...
    if (dp_menu == NULL)
    {
        CONSOLE_ERROR("dp_menu is NULL,cannot create menu components");
        LOG_ERROR("dp_menu is NULL,cannot create menu components");
        return;
    }
